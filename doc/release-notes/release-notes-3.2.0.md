ABLE Core version *3.2.0* is now available from:  <https://github.com/pivx-project/pivx/releases>
...
A full report provided by ABLE developers is available on the [ABLE Website](https://pivx.org/fake-stake-official-pivx-report/), which includes additional findings, mitigation details, and resources for testing. This type of attack has no risk to users' privacy and does not affect their holdings.
