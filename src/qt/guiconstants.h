...
/* Able GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ABLE"
#define QAPP_ORG_DOMAIN "able.org"
#define QAPP_APP_NAME_DEFAULT "ABLE-Qt"
#define QAPP_APP_NAME_TESTNET "ABLE-Qt-testnet"
