...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::ABLE);
...
// Wallet
    ...
    if (settings.contains("nAnonymizePivxAmount"))
        SoftSetArg("-anonymizeableamount", settings.value("nAnonymizePivxAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in able.cpp during shotdown to also remove the window positions
