...
QT_TRANSLATE_NOOP("pivx-core", "Copyright (C) 2015-%i The ABLE Core Developers"),
...
QT_TRANSLATE_NOOP("pivx-core", "Error loading wallet.dat: Wallet requires newer version of ABLE Core"),
...
QT_TRANSLATE_NOOP("pivx-core", "Initialization sanity check failed. ABLE Core is shutting down."),
...
QT_TRANSLATE_NOOP("pivx-core", "Wallet needed to be rewritten: restart ABLE Core to complete"),
