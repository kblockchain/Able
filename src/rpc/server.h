...
extern UniValue DoZableSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzableseed(const UniValue& params, bool fHelp);
extern UniValue getzableseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzable(const UniValue& params, bool fHelp);
extern UniValue dzablestate(const UniValue& params, bool fHelp);
