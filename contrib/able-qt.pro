...
RESOURCES += src/qt/able.qrc src/qt/able_locale.qrc

TRANSLATIONS += src/qt/locale/able_bg.ts \
                src/qt/locale/able_de.ts \
                src/qt/locale/able_en.ts \
                src/qt/locale/able_es.ts \
                src/qt/locale/able_fi.ts \
                src/qt/locale/able_fr.ts \
                src/qt/locale/able_it.ts \
                src/qt/locale/able_ja.ts \
                src/qt/locale/able_pl.ts \
                src/qt/locale/able_pt.ts \
                src/qt/locale/able_ru.ts \
                src/qt/locale/able_sk.ts \
                src/qt/locale/able_sv.ts \
                src/qt/locale/able_vi.ts \
                src/qt/locale/able_zh_CN.ts \
                src/qt/locale/able_zh_TW.ts
