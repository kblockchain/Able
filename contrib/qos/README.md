...
This means one can have an always-on abled instance running, and another local abled/able-qt instance which connects to this node and receives blocks from it.
