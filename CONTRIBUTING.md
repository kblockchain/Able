Contributing to ABLE Core
============================

The ABLE Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/able-project/able/blob/master/doc/translation_process.md)
...
The following applies to code changes to the ABLE Core project, and is not to be
confused with overall ABLE Network Protocol consensus changes.

Whether a pull request is merged into ABLE Core rests with the project merge
...
Patches that change ABLE consensus rules are considerably more involved than
...
Where a patchset proposes to change the ABLE consensus, it must have been
...
The project leader is the release manager for each ABLE Core release.
